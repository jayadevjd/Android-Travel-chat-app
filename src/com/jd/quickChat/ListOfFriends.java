...
//import com.jd.image.Download;
import com.jd.image.Main;

//import com.jd.image.MainActivity;
import com.jd.quickChat.interfacer.Manager;
import com.jd.quickChat.server.MessagingService;
import com.jd.quickChat.toolBox.ControllerOfFriend;
import com.jd.quickChat.typo.InfoOfFriend;
import com.jd.quickChat.typo.InfoStatus;


public class ListOfFriends extends ListActivity 
{
	private static final int ADD_NEW_FRIEND_ID = Menu.FIRST;
	private static final int IMAGE_UPLOAD_ID = Menu.FIRST+1;
	private static final int VIEW_FEED_ID = Menu.FIRST+2;
	...
	public boolean onCreateOptionsMenu(Menu menu) {		
		...
		menu.add(0,IMAGE_UPLOAD_ID,0,R.string.image_upload);
		
		menu.add(0,VIEW_FEED_ID,0,R.string.view_feed);
	...
	{		
		...
		{	  
			...
			{
				Intent i = new Intent(ListOfFriends.this, Main.class);
				startActivity(i);
				return true;
			}
			...
			case VIEW_FEED_ID:
			{
				Intent i = new Intent(ListOfFriends.this,ViewFeed.class);
				startActivity(i);
				return true;
			}
